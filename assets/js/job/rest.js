...
/***/ function(module, exports, __webpack_require__) {
	...
	var init = function init() {
		FN.Plugin.register({
			...
			'job-input': __webpack_require__(156).default,
			'job-floating-layer': __webpack_require__(158).default
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jobInput = __webpack_require__(157);
	
	var _jobInput2 = _interopRequireDefault(_jobInput);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var MyJobInput = function (_JobInput) {
		(0, _inherits3.default)(MyJobInput, _JobInput);
	
		function MyJobInput() {
			(0, _classCallCheck3.default)(this, MyJobInput);
			return (0, _possibleConstructorReturn3.default)(this, (MyJobInput.__proto__ || (0, _getPrototypeOf2.default)(MyJobInput)).apply(this, arguments));
		}
	
		(0, _createClass3.default)(MyJobInput, [{
			key: 'initAttrs',
			value: function initAttrs() {
				var attrs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	
				attrs = (0, _get3.default)(MyJobInput.prototype.__proto__ || (0, _getPrototypeOf2.default)(MyJobInput.prototype), 'initAttrs', this).call(this, attrs) || {};
	
				return (0, _extends3.default)({
					roleInput: '[input-role="input"]',
					roleIcon: '[input-role="icon"]',
					roleEye: '[input-role="eye"]'
				}, attrs);
			}
		}, {
			key: 'render',
			value: function render() {
				this.attrs = (0, _extends3.default)({}, this.attrs);
				this.initEvents();
			...
			key: 'doEye',
			value: function doEye() {
				var $Eye = this.$(this.get('roleEye'));
				var $input = this.$(this.get('roleInput'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var JobInput = function (_FN$Widget) {
		(0, _inherits3.default)(JobInput, _FN$Widget);
	
		function JobInput() {
			(0, _classCallCheck3.default)(this, JobInput);
			return (0, _possibleConstructorReturn3.default)(this, (JobInput.__proto__ || (0, _getPrototypeOf2.default)(JobInput)).apply(this, arguments));
		}
	
		(0, _createClass3.default)(JobInput, [{
			key: 'initAttrs',
			value: function initAttrs() {
				var attrs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	
				attrs = (0, _get3.default)(JobInput.prototype.__proto__ || (0, _getPrototypeOf2.default)(JobInput.prototype), 'initAttrs', this).call(this, attrs) || {};
			...
			value: function render() {
				// this.attrs = {
				// 	...this.attrs,
				// 	...this.parseElementConfig(this.el)
				// };
				// this.initEvents();
			}
		}, {
			...
			value: function initEvents() {
				var that = this;
				var $input = this.$(this.get('roleInput'));
				var $icon = this.$(this.get('roleIcon'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jobFloatingLayer = function (_FN$Widget) {
		(0, _inherits3.default)(jobFloatingLayer, _FN$Widget);
	
		function jobFloatingLayer() {
			(0, _classCallCheck3.default)(this, jobFloatingLayer);
			return (0, _possibleConstructorReturn3.default)(this, (jobFloatingLayer.__proto__ || (0, _getPrototypeOf2.default)(jobFloatingLayer)).apply(this, arguments));
		}
	
		(0, _createClass3.default)(jobFloatingLayer, [{
			key: 'initAttrs',
			value: function initAttrs() {
				var attrs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	
				attrs = (0, _get3.default)(jobFloatingLayer.prototype.__proto__ || (0, _getPrototypeOf2.default)(jobFloatingLayer.prototype), 'initAttrs', this).call(this, attrs) || {};
	
				return (0, _extends3.default)({
					roleWrap: '[data-role="wrap"]',
					roleMask: '[data-role="mask"]',
					roleBox: '[data-role="box"]'
				}, attrs);
			}
		}, {
			key: 'render',
			...
			value: function initEvents() {
				...
				var $wrap = this.$(this.get('roleWrap'));
				var $mask = this.$(this.get('roleMask'));
		...
		return jobFloatingLayer;
	}(FN.Widget);
	
	exports.default = jobFloatingLayer;
	;
